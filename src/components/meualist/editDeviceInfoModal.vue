...
<!--            <Input v-model="formItem.model" placeholder="..."/>-->
        ...
        <FormItem label="PLC型号">
            <el-select v-model="formItem.plcType" filterable allow-create clearable placeholder="..." style="width: 100%">
        ...
        <FormItem label="限制标识">
          <el-select v-model="formItem.lockFlag" filterable allow-create clearable placeholder="..." style="width: 100%">
